...
cache_file_bnn = './BNN_output/BNN_logDist_TrainingOriginalDistanceShuffled_modelC.trace'
...
def get_data(input_data):
    ...
    logDistTrain = np.array(train_dataset['logDistKpc']).astype(floatX)
    logDistTrain_err =  np.array(train_dataset['logDistKpcErr']).astype(floatX)
    ...
    targetsTrain    = np.array(logDistTrain)
    errTargetsTrain = np.array(logDistTrain_err)
...
data = '../train_data/TrainingOriginalDistanceShuffled.csv'
